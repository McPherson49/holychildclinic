            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="page-single-sidebar">
                        ...
                        <div class="page-catagory-list wow fadeInUp">
                            <ul>
                                <li><a href="#faq1">Treatment process</a></li>
                                <li><a href="#faq2">Costs & insurance</a></li>
                                <li><a href="#faq3">Eligibility & preparation</a></li>
                                <li><a href="#faq4">Aftercare & results</a></li>
                            </ul>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="page-faqs-catagery">
                        <!-- FAQs section start -->
                        <div class="faq-accordion page-faq-accordion" id="faq1">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Treatment <span>process</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                                    ...
                                    <div id="collapse1" class="accordion-collapse collapse show" aria-labelledby="heading1" data-bs-parent="#accordion">
                                        <div class="accordion-body">
                                            <p>Schedule a personalized consultation with our experienced fertility specialists and begin your journey with confidence, clarity, and compassionate care.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
                        ...
                        <!-- FAQs section start -->
                        <div class="faq-accordion page-faq-accordion" id="faq2">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Costs & <span>insurance</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.4s">
                                    <h2 class="accordion-header" id="heading7">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse7" aria-expanded="false" aria-controls="collapse7">
                                            Is IVF covered under health insurance?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading10">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse10" aria-expanded="false" aria-controls="collapse10">
                                            What is included in the IVF package?
                                        </button>
                                    </h2>
                        ...
                        <!-- FAQs section start -->
                        <div class="faq-accordion page-faq-accordion" id="faq3">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Eligibility & <span>preservation</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                    <h2 class="accordion-header" id="heading14">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse14" aria-expanded="false" aria-controls="collapse14">
                                            Should I make lifestyle changes before starting IVF?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading15">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse15" aria-expanded="false" aria-controls="collapse15">
                                            Can single women or same-sex couples opt for IVF?
                                        </button>
                                    </h2>
                        ...
                        <!-- FAQs section start -->
                        <div class="faq-accordion page-faq-accordion" id="faq4">
                            <div class="section-title">
                                <h2 class="wow fadeInUp" data-cursor="-opaque">Aftercare & <span>results</span></h2>
                            </div>
                            <!-- FAQ Accordion Start -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.2s">
                                    <h2 class="accordion-header" id="heading17">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse17" aria-expanded="true" aria-controls="collapse17">
                                            What are the chances of success in the first IVF cycle?
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                                    <h2 class="accordion-header" id="heading19">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse19" aria-expanded="true" aria-controls="collapse19">
                                            Are there side effects after the IVF procedure?
                                        </button>
                                    </h2>
...
<!-- Mirrored from html.awaikenthemes.com/ferlix/faqs.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 May 2025 13:02:08 GMT -->
</html>